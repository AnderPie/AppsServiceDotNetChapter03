...
// Partial to allow for painless regeneration of this class through scaffolding command even if the class is extended
public partial class NorthwindDb : DbContext
{
    ...
    // Constructor allowing for options
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
        WriteLine("Configuring Started");
        WriteLine($"Env Var: {Environment.GetEnvironmentVariable("NorthwindConnectionString")!}");
        string connectionString = Environment.GetEnvironmentVariable("NorthwindConnectionString")!;
